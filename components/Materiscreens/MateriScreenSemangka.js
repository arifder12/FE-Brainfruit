  ...
  return (
    <View style={styles.container}>
      <View >
         ...
         <Image
            source={require('../../assets/materi/MateriSemangka.png')}
            style={{ width: 500, height: 400, marginBottom: 10, marginTop: 120, resizeMode:'contain'}}
          />
        </View>
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Materipisang')}>
          <Image
        ...
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Materistrawberry')}>
          <Image
