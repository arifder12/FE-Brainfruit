  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Materijeruk')}>
          <Image
