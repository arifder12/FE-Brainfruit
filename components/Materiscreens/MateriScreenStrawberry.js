  ...
  return (
    <View style={styles.container}>
      <View>
         ...
         <Image
            source={require('../../assets/materi/MateriStroberi.png')}
            style={{width: 500, height: 400, marginBottom: 10, marginTop: 120, resizeMode:'contain'}}
          />
        </View>
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Materisemangka')}>
          <Image
        ...
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('question')}>
          <Image
