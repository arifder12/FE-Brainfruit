...
export default function QuizScreenAlpukat ({ navigation }) {
  ...
  const fetchquizdata = async () => {
    const response = await axios.get(`https://bb02-36-73-32-247.ngrok-free.app/api/quiz/3`);
  ...
  return (
    <View style={styles.container}>
      <View>
       <Image
            source={require('../../assets/quiz/quizalpukat.png')}
         ...
         onPress={
          ()=>{
            ...
            if(answer === quiz.key) {
              ...
              setRight(true);
              navigation.navigate('Quizanggur')
            }
          }
          }>
          { <Image
