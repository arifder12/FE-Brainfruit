...
export default function QuizScreenAnggur ({ navigation }) {
  ...
  const fetchquizdata = async () => {
    const response = await axios.get(`https://bb02-36-73-32-247.ngrok-free.app/api/quiz/4`);
  ...
  return (
    <View style={styles.container}>
      <View >
         ...
         <Image
            source={require('../../assets/quiz/Quizanggur.png')}
        ...
        <TouchableOpacity onPress={
          ()=>{
            ...
            if(answer === quiz.key) {
              ...
              setRight(true);
              navigation.navigate('Quizdelima')
            }
          }
        }>
          <Image
