...
export default function QuizScreenDelima ({ navigation }) {
  ...
  const fetchquizdata = async () => {
    const response = await axios.get(`https://bb02-36-73-32-247.ngrok-free.app/api/quiz/5`);
  ...
  return (
    <View style={styles.container}>
      <View >
         ...
         <Image
            source={require('../../assets/quiz/quizdelima.png')}
